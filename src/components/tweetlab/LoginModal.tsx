                ...
                <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-b from-background/95 to-background/80 backdrop-blur-xl shadow-2xl">
                    ...
                    <div className="relative px-8 py-12 flex flex-col items-center text-center">
                        ...
                        <p className="text-muted-foreground mb-8 max-w-[280px]">
                            Sign in to save your tweet simulations and track your content performance over time.
                        </p>
                        ...
                        <button
                            ...
                            disabled={isLoading}
                            className="group relative w-full flex items-center justify-center gap-3 px-6 py-3.5 rounded-full bg-white text-gray-900 font-semibold text-[15px] shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:scale-100"
                        >
                            {/* Google Icon */}
